...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/extracepat/permission/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/extracepat/scvip/main/"
start=$(date +%s)
secs_to_human() {
...
if [[ $nama = "" ]]; then
echo "TUNNELING JURAGAN" > /etc/xray/username
else
...
wget raw.githubusercontent.com/extracepat/scvip/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
